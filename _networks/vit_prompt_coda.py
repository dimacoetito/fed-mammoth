...
def create_vit_codap(vit_type: str = "1k", num_tasks: int = 10, num_classes: int = 100, pool_size=100, prompt_length=8):
    prompt_param = [num_tasks, [pool_size, prompt_length, 0]]
    return ViTZoo(num_classes=num_classes, pt=True, prompt_param=prompt_param, vit_type=vit_type)
